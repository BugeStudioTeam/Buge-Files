...
public final class ItemDirectoryBinding implements ViewBinding {
  ...
  private ItemDirectoryBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView directoryName) {
  ...
  public static ItemDirectoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDirectoryBinding((MaterialCardView) rootView, directoryName);
    }
