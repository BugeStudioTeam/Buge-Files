...
public final class FragmentRecentBinding implements ViewBinding {
  ...
  private FragmentRecentBinding(@NonNull FrameLayout rootView, @NonNull TextView emptyView,
  ...
  public static FragmentRecentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRecentBinding((FrameLayout) rootView, emptyView, recyclerView);
    }
